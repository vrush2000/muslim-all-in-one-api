...
var handle = (app3) => {
  return getRequestListener(app3.fetch);
};
...
app.get("/generate", async (c) => {
  ...
  try {
    ...
    const qrDataUrl = await import_browser.default.toDataURL(dynamicQris, {
      margin: 2,
      width: 400,
...
app2.route("/v1", v1_default);
app2.route("/api/qris", qris_default);
app2.route("/", routes_default);
app2.notFound((c) => {
